# if using pycharm remember to install opencv-python and numpy
# NOTE: Press Escape key on keyboard to close camera and stop the runtime.
import cv2
import numpy as np

# use yolov3.weights and yolov3.cfg OR yolov4.weights and yolov4.cfg
net = cv2.dnn.readNet('yolov3.weights', 'yolov3.cfg')

classes = []
# if using yolov3 then use coco.txt and if using yolov4 then use custom.txt
